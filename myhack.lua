...
do
    Fluent:Notify({
        Title = "Notification",
        Content = "Aurora's Hub has been loaded!",
        SubContent = "", -- Optional
   ...
   Tabs.Main:AddButton({
        ...
        Callback = function()
            Window:Dialog({
		        ...
		        Tabs.Main:AddButton({
        Title = "All in one gojo anims and quotes. Use this.",
...
loadstring(game:HttpGet"https://raw.githubusercontent.com/tamarixr/tamhub/main/uh.lua")()
        ...
        Callback = function()
            Window:Dialog({
                Title = "dialog 1m",
                Content = "yes or no pick one idk",
                Buttons = {
                    {
                        Title = "ok",
                        Callback = function()
        ...
        Callback = function()
            Window:Dialog({
		        ...
		        Tabs.discord:AddButton({
        Title = "not my discord server (dont join fr)",
        Description = "haha funny",
        Callback = function()
            Window:Dialog({
                Title = "Are you sure?",
